...
{
    public static class SapphireMapData
    {
        ...
        public static class OldRod
        {
            ...
            static OldRod()
            {
                tables = new GBAMap[]
                {
                new RSOldRod("102ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("トサキント", 5, 6),
                })),
                new RSOldRod("103ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("104ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("コイキング", 5, 6),
                })),
                new RSOldRod("105ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("106ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("107ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("108ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("109ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("110ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("111ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("トサキント", 5, 6),
                })),
                new RSOldRod("114ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("トサキント", 5, 6),
                })),
                new RSOldRod("115ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("117ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("トサキント", 5, 6),
                })),
                new RSOldRod("118ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSRoute119OldRod("119ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSFeebasSpotOldRod("119ばんどうろ(ヒンバススポット)", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("120ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("トサキント", 5, 6),
                })),
                new RSOldRod("121ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("122ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("123ばんどうろ", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("124ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("125ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("126ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("127ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("128ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("129ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("130ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("131ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("132ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("133ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("134ばんすいどう", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("トウカシティ", 10, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("トサキント", 5, 6),
                })),
                new RSOldRod("ムロタウン", 10, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("カイナシティ", 10, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("ミナモシティ", 10, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("トクサネシティ", 10, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("ルネシティ", 10, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("キナギタウン", 10, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("サイユウシティ", 10, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("すてられぶね", 20, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("りゅうせいのたき", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("トサキント", 5, 6),
                })),
                new RSOldRod("あさせのほらあな", 10, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("かいていどうくつ", 10, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("メノクラゲ", 5, 6),
                })),
                new RSOldRod("チャンピオンロード", 30, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("トサキント", 5, 6),
                })),
                new RSSafariOldRod("サファリゾーン", 35, GBASlot.CreateTable(new (string, uint, uint)[]
                {
                    ("コイキング", 5, 6),
                    ("トサキント", 5, 6),
                })),
